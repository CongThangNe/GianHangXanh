...
<body class="bg-background-light dark:bg-background-dark font-display text-text-light dark:text-text-dark">
    <div class="relative flex min-h-screen w-full flex-col group/design-root overflow-x-hidden">
        <div class="layout-container flex h-full grow flex-col">
            ...
            <!-- TopNavBar -->
            <header class="sticky top-0 z-50 flex justify-center bg-green-500/80 backdrop-blur-sm border-b border-solid border-border-light dark:border-border-dark text-white">
        ...
        Đăng ký
                        ...
                        <div class="hidden md:block relative" x-data="{ open: false }">
                            ...
                            <div
                                ...
                                <a href="#" class="block px-4 py-2 text-sm hover:bg-green-300 transition-colors">Hồ sơ cá nhân</a>
                                <a href="#" class="block px-4 py-2 text-sm hover:bg-green-300 transition-colors">Đơn hàng</a>
                                <hr class="my-1 border-border-light dark:border-border-dark">
                                <form action="{{ route('logout') }}" method="POST">
                                    @csrf
                                    <button type="submit" class="w-full text-left px-4 py-2 text-sm hover:bg-green-300 transition-colors">Đăng xuất</button>
                                </form>
                            </div>
                        </div>
                        @endguest
